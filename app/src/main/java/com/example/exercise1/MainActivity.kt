...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.buttonCalculate).setOnClickListener {
            ...
            textLoan.setText(String.format("Loan : RM %.2f", carLoan))
            textInterest.setText(String.format("Interest : RM %.2f", carInterest))
            textMonthlyRepayment.setText(String.format("Monthly Repayment : RM %.2f", monthlyRepayment))
